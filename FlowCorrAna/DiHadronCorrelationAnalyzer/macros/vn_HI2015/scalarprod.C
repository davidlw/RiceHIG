void scalarprod()
{
//  TFile* f = new TFile("/net/hisrv0001/home/davidlw/scratch1/DiHadronCorrelations/outputs_312/HydjetReco_Minbias_5TeV/merged/scalarprod_rc_dijet220_n400_v9.root");
//  TFile* f_hf = new TFile("/net/hisrv0001/home/davidlw/scratch1/DiHadronCorrelations/outputs_312/HydjetReco_Minbias_5TeV/merged/scalarprod_rc_dijet220_n400_hf_v9.root");
  TFile* f = new TFile("/net/hisrv0001/home/davidlw/scratch1/DiHadronCorrelations/outputs_312/HIData_Minbias_5TeV/merged/FlowVn2015_1M_cent010_v4.root");
  TFile* f_hf = new TFile("/net/hisrv0001/home/davidlw/scratch1/DiHadronCorrelations/outputs_312/HIData_Minbias_5TeV/merged/FlowVn2015_1M_hf_cent010_v4.root");
...
//    V4[i] = hsignal_1D[i]->GetBinContent(3)-hbackground_1D[i]->GetBinContent(3);
    V2[i] = hsignal_1D[i]->GetBinContent(1);
    V3[i] = hsignal_1D[i]->GetBinContent(2);
    V4[i] = hsignal_1D[i]->GetBinContent(3);
  ...
  TGraphErrors* gr_v2 = new TGraphErrors(16,pt,v2,pt_err,v2_err);
  TGraphErrors* gr_v3 = new TGraphErrors(16,pt,v3,pt_err,v3_err);
  TGraphErrors* gr_v4 = new TGraphErrors(16,pt,v4,pt_err,v4_err);
  ...
  TH2D* htmp = new TH2D("htmp",";p_{T} (GeV/c); v_{2}", 1000, 0, 100, 1000, -0.02, 1.0);
