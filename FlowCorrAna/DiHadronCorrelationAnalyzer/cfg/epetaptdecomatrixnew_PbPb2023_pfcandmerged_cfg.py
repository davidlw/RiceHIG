...
process.epetaptdecomatrixnew_ana_PbPb2023.TrgTrackCollection = cms.InputTag("generalAndHiPixelTracks")
...
process.epetaptdecomatrixnew_ana_PbPb2023.pttrgmin = cms.vdouble(0.3)
process.epetaptdecomatrixnew_ana_PbPb2023.pttrgmax = cms.vdouble(3.0)
process.epetaptdecomatrixnew_ana_PbPb2023.ptassmin = cms.vdouble(0.0)
process.epetaptdecomatrixnew_ana_PbPb2023.ptassmax = cms.vdouble(0.0)
...
process.epetaptdecomatrixnew_ana_PbPb2023.EffFileName = cms.string('EffCorrectionsTracks2023PbPb_Merged3D_v3.root')
process.epetaptdecomatrixnew_ana_PbPb2023.FakFileName = cms.string('EffCorrectionsTracks2023PbPb_Merged3D_v3.root')
process.epetaptdecomatrixnew_ana_PbPb2023.EffHistName = cms.string('Eff3D')
process.epetaptdecomatrixnew_ana_PbPb2023.FakHistName = cms.string('Fak3D')
...
# Define the output
process.TFileService = cms.Service("TFileService", fileName = cms.string('epetaptdecomatrixnew_pfcandmerged.root'))
