...
process.TFileService = cms.Service("TFileService",
                                   fileName = cms.string('conversion.root')
                                   )

process.conversion_ana.nmin = cms.int32(185)
process.conversion_ana.nmax = cms.int32(250)

process.ana = cms.Path(process.eventFilter_HM * process.conversion_ana)
