...
for i in range(0,1):
    dataMap[("HIPhysicsRawPrime"+str(i))] = { "PD": ("/HIPhysicsRawPrime"+str(i)+"/HIRun2023A-PromptReco-v2/MINIAOD"), "Units": 20, "Memory": 4600, "RunTime": 2100, "PSet": "epptdecomatrixnew_PbPb2023_pfcand_cfg.py" } # UCC

## Submit the muon PDs
for key, val in dataMap.items():
    config.General.requestName = 'epptdecomatrixnew_'+key+'_HIRun2023_PRMB_weunco_20250901v2'
