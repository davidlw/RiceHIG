...
process.load('FlowCorrAna.DiHadronCorrelationAnalyzer.hfCoincFilter_cff')
...
process.corr_ana_PbPb2023_hfcoin = process.corr_ana_PbPb2023.clone()
process.corr_ana_PbPb2023_zdcor_hfcoin = process.corr_ana_PbPb2023.clone()
process.corr_ana_PbPb2023_zdcorhm_hfcoin = process.corr_ana_PbPb2023.clone()
process.corr_ana_PbPb2023_zb_hfcoin = process.corr_ana_PbPb2023.clone()
...
process.ana_step_hfcoin = cms.Path(process.eventFilter_MB * process.hfCoincFilter2Th4 *
  process.corr_ana_PbPb2023_hfcoin
)

process.ana_step_zdcor_hfcoin = cms.Path(process.eventFilter_zdcor * process.hfCoincFilter2Th4 *
  process.corr_ana_PbPb2023_zdcor_hfcoin
)

process.ana_step_zdcorhm_hfcoin = cms.Path(process.eventFilter_zdcor * process.eventFilter_MB * process.hfCoincFilter2Th4 *
  process.corr_ana_PbPb2023_zdcorhm_hfcoin
)

process.ana_step_zb_hfcoin = cms.Path(process.eventFilter_zb * process.hfCoincFilter2Th4 *
  process.corr_ana_PbPb2023_zb_hfcoin
)
...
#    process.eventFilter_MB_step,
    ...
    process.ana_step_zb,
    process.ana_step_hfcoin,
    process.ana_step_zdcor_hfcoin,
    process.ana_step_zdcorhm_hfcoin,
    process.ana_step_zb_hfcoin
