...
process.ana_step = cms.Path(process.eventFilter_HM * process.vnptcorr_ana_PbPb2018)

# Define the output
process.TFileService = cms.Service("TFileService", fileName = cms.string('vnptcorr.root'))
