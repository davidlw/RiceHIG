...
process.corr_ana_N1851000 = process.corr_ana.clone();
process.corr_ana_N1851000.nmin = cms.int32(185)
process.corr_ana_N1851000.nmax = cms.int32(250)
process.corr_ana_N1851000.pttrgmin = cms.vdouble(0.3,0.5,0.7,1.0,1.5,2.0,2.5,3.0,4.0,5.0,6.0,8.0,10.0,12.0,16.0)
process.corr_ana_N1851000.pttrgmax = cms.vdouble(0.5,0.7,1.0,1.5,2.0,2.5,3.0,4.0,5.0,6.0,8.0,10.0,12.0,16.0,20.0)

process.ana_N1851000 = cms.Path(process.eventFilter_HM*process.corr_ana_N1851000)
