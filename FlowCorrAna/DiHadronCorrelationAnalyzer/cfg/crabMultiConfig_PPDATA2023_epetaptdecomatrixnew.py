...
config.Data.lumiMask = 'Cert_Collisions2023_ppref_373710_Muon.json'
config.Data.runRange = '373710'
...
for i in range(0,5):
    dataMap[("PPRefZeroBias"+str(i))] = { "PD": ("/PPRefZeroBias"+str(i)+"/Run2023F-PromptReco-v1/MINIAOD"), "Units": 20, "Memory": 4000, "RunTime": 2100, "PSet": "epetaptdecomatrixnew_pp2023_pfcand_cfg.py" }

## Submit the muon PDs
for key, val in dataMap.items():
    config.General.requestName = 'epetaptdecomatrixnew_'+key+'_ppRef2023_PRZB_weunco_20250901v1'
