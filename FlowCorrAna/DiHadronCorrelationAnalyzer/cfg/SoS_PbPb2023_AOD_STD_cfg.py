...
'root://xrootd-cms.infn.it//store/group/phys_heavyions/wangj/RECO2025PbPb/aod_PhysicsHITrackerNZS4_399465_NZS_5per/reco_run399465_ls0037_streamPhysicsHITrackerNZS4_StorageManager.root'
)
)
...
# Define the output
process.TFileService = cms.Service("TFileService", fileName = cms.string('SoS_2025.root'))
