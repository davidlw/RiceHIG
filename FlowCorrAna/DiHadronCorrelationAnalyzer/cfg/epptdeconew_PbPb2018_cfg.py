...
process.load("FlowCorrAna.DiHadronCorrelationAnalyzer.epptdeconew_cff")
process.ana_step = cms.Path(process.eventFilter_HM * process.epptdeco_ana_PbPb2018)
process.epptdeco_ana_PbPb2018.centmin = cms.int32(0)
process.epptdeco_ana_PbPb2018.centmax = cms.int32(200)

# Define the output
process.TFileService = cms.Service("TFileService", fileName = cms.string('epptdeco.root'))
