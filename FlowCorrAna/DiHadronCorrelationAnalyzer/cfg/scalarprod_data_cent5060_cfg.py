...
process.scalarprod_ana_HI = process.scalarprod_ana_HI.clone()
process.scalarprod_ana_HI.centmin = cms.int32(100)
process.scalarprod_ana_HI.centmax = cms.int32(120)
