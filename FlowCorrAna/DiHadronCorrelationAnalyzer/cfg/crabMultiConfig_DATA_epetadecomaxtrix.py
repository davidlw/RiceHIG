...
for i in range(0,1):
    dataMap[("HIMinimumBias"+str(i))] = { "PD": ("/HIMinimumBias"+str(i)+"/HIRun2018A-04Apr2019-v1/AOD"), "Units": 20, "Memory": 3000, "RunTime": 2000, "PSet": "epetadecomatrix_PbPb2018_cfg.py" }

## Submit the muon PDs
for key, val in dataMap.items():
    config.General.requestName = 'epetadecomatrix_'+key+'_HIRun2018_04Apr2019_20210208v1_cent05_noptweight'
