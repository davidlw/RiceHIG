...
config.Data.lumiMask = 'Cert_Collisions2025Nene_394269_394272_golden.json'
...
for i in range(0,1):
    dataMap[("IonPhysics"+str(i))] = { "PD": ("/IonPhysics"+str(i)+"/NeNeRun2025-PromptReco-v1/MINIAOD"), "Units": 25, "Memory": 4600, "RunTime": 2100, "PSet": "epetaptdecomatrixnew_NeNe2025_pfcand_cfg.py" } 

## Submit the muon PDs
for key, val in dataMap.items():
    config.General.requestName = 'epetaptdecomatrixnew_'+key+'_NeNe2025PRMB_weco_20250919v1'
