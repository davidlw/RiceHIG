...
process.epptdecomatrixnew_ana_pp2023.TriggerID = cms.string('Track')
process.epptdecomatrixnew_ana_pp2023.AssociateID = cms.string('Track')
process.epptdecomatrixnew_ana_pp2023.etatrgmin = cms.double(-2.4)
process.epptdecomatrixnew_ana_pp2023.etatrgmax = cms.double(2.4)
process.epptdecomatrixnew_ana_pp2023.etaassmin = cms.double(-2.4)
process.epptdecomatrixnew_ana_pp2023.etaassmax = cms.double(2.4)
#process.epptdecomatrixnew_ana_pp2023.EffFileName = cms.string('.root')
#process.epptdecomatrixnew_ana_pp2023.FakFileName = cms.string('.root')
#process.epptdecomatrixnew_ana_pp2023.EffHistName = cms.string('hEff_3D')
#process.epptdecomatrixnew_ana_pp2023.FakHistName = cms.string('hFak_3D')

process.ana_step = cms.Path(process.eventFilter_MB * process.epptdecomatrixnew_ana_pp2023)

# Define the output
process.TFileService = cms.Service("TFileService", fileName = cms.string('epptdecomatrixnew_pp_pfcand.root'))
