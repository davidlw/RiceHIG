...
process.corr_ana_PbPb2023.TrgTrackCollection = cms.InputTag("generalTracks")
process.corr_ana_PbPb2023.VertexCollection = cms.InputTag("offlinePrimaryVertices")
#process.corr_ana_PbPb2023.EffFileName = cms.string('GeneralTracks_Eff_3D_Nominal_MB.root')
#process.corr_ana_PbPb2023.EffHistName = cms.string('hEff_3D')
#process.corr_ana_PbPb2023.FakFileName = cms.string('GeneralTracks_Eff_3D_Nominal_MB.root')
#process.corr_ana_PbPb2023.FakHistName = cms.string('hFak_3D')
process.corr_ana_PbPb2023.pttrgmin = cms.vdouble(0.0)
process.corr_ana_PbPb2023.pttrgmax = cms.vdouble(10000.0)
process.corr_ana_PbPb2023.ptassmin = cms.vdouble(0.0)
process.corr_ana_PbPb2023.ptassmax = cms.vdouble(0.0)
process.corr_ana_PbPb2023.IsCorr = cms.bool(False)
process.corr_ana_PbPb2023.IsDebug = cms.bool(True)
process.corr_ana_PbPb2023.IsHITrkQuality = cms.bool(True)
process.corr_ana_PbPb2023.IsPPTrkQuality = cms.bool(False)
process.corr_ana_PbPb2023.centmin = cms.int32(0)
process.corr_ana_PbPb2023.centmax = cms.int32(200)

process.corr_ana_PbPb2023_gen = process.corr_ana_PbPb2023.clone()
process.corr_ana_PbPb2023_gen.TriggerID = cms.string('PackedGenParticle')

process.ana_step = cms.Path(process.eventFilter_MB *
  process.corr_ana_PbPb2023
)

process.ana_gen_step = cms.Path(process.eventFilter_MB *
  process.corr_ana_PbPb2023_gen
)
...
# Define the output
process.TFileService = cms.Service("TFileService", fileName = cms.string('dihadroncorrelation_2023_mc.root'))

# Define the process schedule
process.schedule = cms.Schedule(
#    process.eventFilter_MB_step,
    process.ana_step,
    process.ana_gen_step,    
#    process.output_step
)
