...
for i in range(2,6):
    dataMap[("HIMinimumBias"+str(i))] = { "PD": ("/HIMinimumBias"+str(i)+"/HIRun2018A-04Apr2019-v1/AOD"), "Units": 15, "Memory": 4000, "RunTime": 2000, "PSet": "dihadroncorrelation_PbPb2018_cfg.py" }

## Submit the muon PDs
for key, val in dataMap.items():
    config.General.requestName = 'DiHadronCorrelation_'+key+'_HIRun2018_04Apr2019_mergedtracks_20200716'
