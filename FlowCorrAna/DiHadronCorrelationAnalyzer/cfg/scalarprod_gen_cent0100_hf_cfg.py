...
process.scalarprod_ana_HI_hf.TriggerID = cms.string('GenParticle')
process.scalarprod_ana_HI_hf.AssociateID = cms.string('GenParticle')
#process.scalarprod_ana_HI.IsGenMult = cms.bool(True)
#process.scalarprod_ana_HI.IsVtxSel = cms.bool(False)
process.scalarprod_ana_HI_hf.pttrgmin = cms.vdouble(0.5)
process.scalarprod_ana_HI_hf.pttrgmax = cms.vdouble(10000.0)
process.scalarprod_ana_HI_hf.ptassmin = cms.vdouble(0.5)
process.scalarprod_ana_HI_hf.ptassmax = cms.vdouble(10000.0)
