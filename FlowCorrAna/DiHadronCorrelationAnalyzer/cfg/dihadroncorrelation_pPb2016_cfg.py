...
process.corr_ana.pttrgmin = cms.vdouble(0.3)
process.corr_ana.pttrgmax = cms.vdouble(3.0)
process.corr_ana.ptassmin = cms.vdouble(0.3)
process.corr_ana.ptassmax = cms.vdouble(3.0)
process.corr_ana.nmin = cms.int32(250)
process.corr_ana.nmax = cms.int32(270)
