...
process.hltHM_pPb.HLTPaths = ['HLT_PAFullTracks_Multiplicity280_v*']
...
process.ana_N370390 = cms.Path(process.eventFilter_HM*process.corr_ana_N370390)
process.ana_N390420 = cms.Path(process.eventFilter_HM*process.corr_ana_N390420)
process.ana_N420500 = cms.Path(process.eventFilter_HM*process.corr_ana_N420500)
