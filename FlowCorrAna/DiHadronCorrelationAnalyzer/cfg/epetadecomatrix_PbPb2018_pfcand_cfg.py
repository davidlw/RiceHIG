...
process.epetadecomatrix_ana_PbPb2018.centmax = cms.int32(1)
# running on particle flow
process.epetadecomatrix_ana_PbPb2018.etaBinWidth = cms.double(0.4)
process.epetadecomatrix_ana_PbPb2018.TriggerID = cms.string('PFCandidate')
process.epetadecomatrix_ana_PbPb2018.AssociateID = cms.string('PFCandidate')
process.epetadecomatrix_ana_PbPb2018.etatrgmin = cms.double(-5)
process.epetadecomatrix_ana_PbPb2018.etatrgmax = cms.double(5)
process.epetadecomatrix_ana_PbPb2018.etaassmin = cms.double(-5)
process.epetadecomatrix_ana_PbPb2018.etaassmax = cms.double(5)
process.epetadecomatrix_ana_PbPb2018.pttrgmin = cms.vdouble(0.0)
process.epetadecomatrix_ana_PbPb2018.pttrgmax = cms.vdouble(10000.0)
process.epetadecomatrix_ana_PbPb2018.ptassmin = cms.vdouble(0.0)
process.epetadecomatrix_ana_PbPb2018.ptassmax = cms.vdouble(1000.0)
process.epetadecomatrix_ana_PbPb2018.IsPtWeightTrg = cms.bool(True)
process.epetadecomatrix_ana_PbPb2018.IsPtWeightAss = cms.bool(True)

# Define the output
process.TFileService = cms.Service("TFileService", fileName = cms.string('epetadecomatrix_pfcand.root'))
