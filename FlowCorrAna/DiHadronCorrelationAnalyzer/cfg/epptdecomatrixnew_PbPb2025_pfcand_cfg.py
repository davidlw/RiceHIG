...
#process.epptdecomatrixnew_ana_OO2025.TriggerID = cms.string('PackedPFHadron')
#process.epptdecomatrixnew_ana_OO2025.AssociateID = cms.string('PackedPFHadron')
process.epptdecomatrixnew_ana_OO2025.TriggerID = cms.string('Track')
process.epptdecomatrixnew_ana_OO2025.AssociateID = cms.string('Track')
process.epptdecomatrixnew_ana_OO2025.etatrgmin = cms.double(-2.4)
process.epptdecomatrixnew_ana_OO2025.etatrgmax = cms.double(2.4)
process.epptdecomatrixnew_ana_OO2025.etaassmin = cms.double(-2.4)
process.epptdecomatrixnew_ana_OO2025.etaassmax = cms.double(2.4)
process.epptdecomatrixnew_ana_OO2025.EffFileName = cms.string('EffFakVsNpixel3D_OO2025.root')
process.epptdecomatrixnew_ana_OO2025.FakFileName = cms.string('')
process.epptdecomatrixnew_ana_OO2025.EffHistName = cms.string('hCombFit3D')
process.epptdecomatrixnew_ana_OO2025.FakHistName = cms.string('')
...
process.epptdecomatrixnew_ana_OO2025_cent01 = process.epptdecomatrixnew_ana_OO2025.clone()
process.epptdecomatrixnew_ana_OO2025_cent05 = process.epptdecomatrixnew_ana_OO2025.clone()
process.epptdecomatrixnew_ana_OO2025_cent510 = process.epptdecomatrixnew_ana_OO2025.clone()
process.epptdecomatrixnew_ana_OO2025_cent1030 = process.epptdecomatrixnew_ana_OO2025.clone()
process.epptdecomatrixnew_ana_OO2025_cent3050 = process.epptdecomatrixnew_ana_OO2025.clone()
process.epptdecomatrixnew_ana_OO2025_cent5070 = process.epptdecomatrixnew_ana_OO2025.clone()
process.epptdecomatrixnew_ana_OO2025_cent01.hfsummin = cms.double(395.659)
process.epptdecomatrixnew_ana_OO2025_cent01.hfsummax = cms.double(10000.0)
process.epptdecomatrixnew_ana_OO2025_cent05.hfsummin = cms.double(316.984)
process.epptdecomatrixnew_ana_OO2025_cent05.hfsummax = cms.double(10000.0)
process.epptdecomatrixnew_ana_OO2025_cent510.hfsummin = cms.double(266.531)
process.epptdecomatrixnew_ana_OO2025_cent510.hfsummax = cms.double(316.984)
process.epptdecomatrixnew_ana_OO2025_cent1030.hfsummin = cms.double(144.623)
process.epptdecomatrixnew_ana_OO2025_cent1030.hfsummax = cms.double(266.531)
process.epptdecomatrixnew_ana_OO2025_cent3050.hfsummin = cms.double(75.4546)
process.epptdecomatrixnew_ana_OO2025_cent3050.hfsummax = cms.double(144.623)
process.epptdecomatrixnew_ana_OO2025_cent5070.hfsummin = cms.double(35.624)
process.epptdecomatrixnew_ana_OO2025_cent5070.hfsummax = cms.double(75.4546)

process.ana_step_cent01 = cms.Path(process.eventFilter_MB * process.epptdecomatrixnew_ana_OO2025_cent01)
process.ana_step_cent05 = cms.Path(process.eventFilter_MB * process.epptdecomatrixnew_ana_OO2025_cent05)
process.ana_step_cent510 = cms.Path(process.eventFilter_MB * process.epptdecomatrixnew_ana_OO2025_cent510)
process.ana_step_cent1030 = cms.Path(process.eventFilter_MB * process.epptdecomatrixnew_ana_OO2025_cent1030)
process.ana_step_cent3050 = cms.Path(process.eventFilter_MB * process.epptdecomatrixnew_ana_OO2025_cent3050)
process.ana_step_cent5070 = cms.Path(process.eventFilter_MB * process.epptdecomatrixnew_ana_OO2025_cent5070)
