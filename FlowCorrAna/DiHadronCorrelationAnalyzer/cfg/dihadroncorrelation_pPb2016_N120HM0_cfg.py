...
process.hltHM_pPb.HLTPaths = ['HLT_PAFullTracks_Multiplicity120*_v*','HLT_PAFullTracks_Multiplicity150*_v*']
...
process.corr_ana_N120135 = process.corr_ana.clone();
process.corr_ana_N120135.nmin = cms.int32(120)
process.corr_ana_N120135.nmax = cms.int32(135)
process.corr_ana_N135150 = process.corr_ana.clone();
process.corr_ana_N135150.nmin = cms.int32(135)
process.corr_ana_N135150.nmax = cms.int32(150)
process.corr_ana_N150160 = process.corr_ana.clone();
process.corr_ana_N150160.nmin = cms.int32(150)
process.corr_ana_N150160.nmax = cms.int32(160)
process.corr_ana_N160185 = process.corr_ana.clone();
process.corr_ana_N160185.nmin = cms.int32(160)
process.corr_ana_N160185.nmax = cms.int32(185)

process.ana_N120135 = cms.Path(process.eventFilter_HM*process.corr_ana_N120135)
process.ana_N135150 = cms.Path(process.eventFilter_HM*process.corr_ana_N135150)
process.ana_N150160 = cms.Path(process.eventFilter_HM*process.corr_ana_N150160)
process.ana_N160185 = cms.Path(process.eventFilter_HM*process.corr_ana_N160185)
