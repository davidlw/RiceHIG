...
process.ana = cms.Path(process.selectV0CandidatesNewkshort*process.corr_ana_pp_ks_sig)
...
process.corr_ana_pp_ks_sig.V0CandidateCollection = cms.string('selectV0CandidatesNewkshort')
process.corr_ana_pp_ks_sig.TriggerID = cms.string('Kshort')
process.corr_ana_pp_ks_sig.nmin = cms.int32(105)
process.corr_ana_pp_ks_sig.nmax = cms.int32(1000)
