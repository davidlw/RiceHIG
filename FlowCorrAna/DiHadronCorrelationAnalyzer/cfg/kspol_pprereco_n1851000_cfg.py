...
process.TFileService = cms.Service("TFileService",
                                   fileName = cms.string('kspol.root')
                                   )
...
process.corr_ana.pttrgmin = cms.vdouble(0.4)
process.corr_ana.pttrgmax = cms.vdouble(6.0)
process.corr_ana.massmean_trg = cms.vdouble(0.497)
process.corr_ana.masswidth_trg = cms.vdouble(0.007)
...
process.corr_ana.v0AglCut = cms.double(0.2)
