...
process.ana_N010 = cms.Path(process.eventFilter_HM*process.corr_ana_N010)
process.ana_N1020 = cms.Path(process.eventFilter_HM*process.corr_ana_N1020)
process.ana_N2030 = cms.Path(process.eventFilter_HM*process.corr_ana_N2030)
