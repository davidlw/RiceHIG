...
process.scalarprod_ana_hp_hfp.nmin = cms.int32(185)
process.scalarprod_ana_hp_hfp.nmax = cms.int32(250)
...
process.ana_hp_hfp = cms.Path(process.scalarprod_ana_hp_hfp)
process.ana_hp_hfm = cms.Path(process.scalarprod_ana_hp_hfm)
