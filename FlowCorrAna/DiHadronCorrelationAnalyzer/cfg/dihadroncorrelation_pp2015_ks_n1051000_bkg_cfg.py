...
process.ana = cms.Path(process.selectV0CandidatesNewkshort*process.corr_ana_pp_ks_bkg)
...
process.corr_ana_pp_ks_bkg.V0CandidateCollection = cms.string('selectV0CandidatesNewkshort')
process.corr_ana_pp_ks_bkg.TriggerID = cms.string('Kshort')
process.corr_ana_pp_ks_bkg.nmin = cms.int32(105)
process.corr_ana_pp_ks_bkg.nmax = cms.int32(1000)
