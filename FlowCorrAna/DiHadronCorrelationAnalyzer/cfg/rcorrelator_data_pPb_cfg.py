...
process.load("FlowCorrAna.DiHadronCorrelationAnalyzer.rcorrelator_cff")
...
process.TFileService = cms.Service("TFileService",
                                   fileName = cms.string('rcorrelator.root')
                                   )

process.rcorrelator_ana.nmin = cms.int32(185)
process.rcorrelator_ana.nmax = cms.int32(250)

process.ana = cms.Path(process.eventFilter_HM * process.rcorrelator_ana)
