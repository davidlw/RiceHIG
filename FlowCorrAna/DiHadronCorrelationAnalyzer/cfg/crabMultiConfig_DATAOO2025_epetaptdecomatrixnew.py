...
for i in range(1,10):
    dataMap[("IonPhysics"+str(i))] = { "PD": ("/IonPhysics"+str(i)+"/OORun2025-PromptReco-v1/MINIAOD"), "Units": 10, "Memory": 3000, "RunTime": 2100, "PSet": "epetaptdecomatrixnew_OO2025_pfcand_cfg.py" } 

## Submit the muon PDs
for key, val in dataMap.items():
    config.General.requestName = 'epetaptdecomatrixnew_'+key+'_OO2025PRBin0_effv1pu2_20251016v5'
