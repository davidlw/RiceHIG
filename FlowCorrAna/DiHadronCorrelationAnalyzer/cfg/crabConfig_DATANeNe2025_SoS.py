...
for i in range(0,10):
    dataMap[("IonPhysics"+str(i))] = { "PD": ("/IonPhysics"+str(i)+"/NeNeRun2025-PromptReco-v1/MINIAOD"), "Units": 25, "Memory": 3000, "RunTime": 2100, "PSet": "SoS_NeNe2025_MINIAOD_cfg.py" } 

## Submit the muon PDs
for key, val in dataMap.items():
    config.General.requestName = 'sosana_'+key+'_NeNe2025PR_effv1pu2_20251018v3'
