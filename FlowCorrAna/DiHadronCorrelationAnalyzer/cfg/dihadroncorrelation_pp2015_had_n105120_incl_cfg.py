...
process.corr_ana_pp.nmin = cms.int32(105)
process.corr_ana_pp.nmax = cms.int32(120)
process.corr_ana_pp.pttrgmin = cms.vdouble(0.3)
process.corr_ana_pp.pttrgmax = cms.vdouble(3.0)
