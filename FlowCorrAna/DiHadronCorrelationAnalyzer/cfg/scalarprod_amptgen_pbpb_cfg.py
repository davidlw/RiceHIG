...
process.ana_step_trkhfp = cms.Path(process.scalarprod_ana_gen_trkhfp)
process.ana_step_trkhfm = cms.Path(process.scalarprod_ana_gen_trkhfm)
process.ana_step_hfphfm = cms.Path(process.scalarprod_ana_gen_hfphfm)
