...
process.hltHIMB.HLTPaths = ['HLT_HIUCC*_v*'] # for allphysics
...
'/store/hidata/HIRun2015/HIFlowCorr/AOD/25Aug2016-v1/00000/00DF57DD-8370-E611-9FF9-141877449316.root'
                )
...
process.epetadecomatrix_ana_HI.centmax = cms.int32(1)
process.epetadecomatrix_ana_HI.centmin = cms.int32(0)
process.epetadecomatrix_ana_HI.centmax = cms.int32(1)
