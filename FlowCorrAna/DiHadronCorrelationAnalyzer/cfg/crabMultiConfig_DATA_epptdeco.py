...
for i in range(0,2):
    dataMap[("HIMinimumBias"+str(i))] = { "PD": ("/HIMinimumBias"+str(i)+"/HIRun2018A-04Apr2019-v1/AOD"), "Units": 40, "Memory": 2000, "RunTime": 2000, "PSet": "epptdeco_PbPb2018_cfg.py" }

## Submit the muon PDs
for key, val in dataMap.items():
    config.General.requestName = 'epptdeco_'+key+'_HIRun2018_04Apr2019_20200716'
