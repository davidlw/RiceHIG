...
process.ana_N3040 = cms.Path(process.eventFilter_HM*process.corr_ana_N3040)
process.ana_N4050 = cms.Path(process.eventFilter_HM*process.corr_ana_N4050)
process.ana_N5060 = cms.Path(process.eventFilter_HM*process.corr_ana_N5060)
