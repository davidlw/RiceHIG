...
process.corr_ana.nmax = cms.int32(20)

process.corr_ana_N020 = process.corr_ana.clone()
process.corr_ana_N020.nmin = cms.int32(0)
process.corr_ana_N020.nmax = cms.int32(20)

process.ana_N020 = cms.Path(process.eventFilter_HM*process.corr_ana_N020)
