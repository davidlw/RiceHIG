...
for i in range(0,1):
    dataMap[("PPRefZeroBias"+str(i))] = { "PD": ("/PPRefZeroBias"+str(i)+"/Run2023F-PromptReco-v1/MINIAOD"), "Units": 10, "Memory": 4000, "RunTime": 2100, "PSet": "epptdecomatrixnew_pp2023_pfcand_cfg.py" }

## Submit the muon PDs
for key, val in dataMap.items():
    config.General.requestName = 'epptdecomatrixnew_'+key+'_ppRef2023_PRZB_weunco_20250901v6'
