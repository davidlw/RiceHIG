...
process.source = cms.Source("PoolSource",
   fileNames = cms.untracked.vstring(
           'root://cmsxrootd.fnal.gov//store/mc/HINOOSpring25MiniAOD/MinBias_OO_5p36TeV_hijing/MINIAODSIM/NoPU_150X_mcRun3_2025_forOO_realistic_v7-v2/2520000/6c17c1d7-62f9-42f7-9323-fe3b1baa54bc.root'
   )
)
...
process.GlobalTag.globaltag = cms.string('150X_mcRun3_2025_forOO_realistic_v7')
...
process.sosmeanpt_ana.IsGenMult = cms.bool(True)
process.sosmeanpt_ana.IsZDC = cms.bool(False)
...
# Define the output
process.TFileService = cms.Service("TFileService", fileName = cms.string('SoS_OO2025_mc.root'))
