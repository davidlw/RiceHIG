...
for i in range(10,15):
    dataMap[("IonPhysics"+str(i))] = { "PD": ("/IonPhysics"+str(i)+"/NeNeRun2025-PromptReco-v1/MINIAOD"), "Units": 15, "Memory": 3000, "RunTime": 2100, "PSet": "epptdecomatrixnew_NeNe2025_pfcand_cfg.py" } 

## Submit the muon PDs
for key, val in dataMap.items():
    config.General.requestName = 'epptdecomatrixnew_'+key+'_NeNe2025PR_effv1pu2_20251207v1'
