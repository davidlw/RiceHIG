...
process.corr_ana_PbPb2018.etamultmin = cms.double(0.0)
...
process.corr_ana_PbPb2018.etatrgmin = cms.double(1.5)
process.corr_ana_PbPb2018.etatrgmax = cms.double(2.0)
