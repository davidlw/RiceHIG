...
config.Data.lumiMask = 'OO_bin2v1.json'
...
for i in range(0,10):
    dataMap[("IonPhysics"+str(i))] = { "PD": ("/IonPhysics"+str(i)+"/OORun2025-PromptReco-v1/MINIAOD"), "Units": 25, "Memory": 3000, "RunTime": 2100, "PSet": "SoS_OO2025_MINIAOD_cfg.py" } 

## Submit the muon PDs
for key, val in dataMap.items():
    config.General.requestName = 'sosana_'+key+'_OO2025PRBin2_effv1pu2_20251018v4'
