...
corr_ana = cms.EDAnalyzer('DiHadronCorrelationMultiAnalyzerChAsym',
  ...
  chasymmin = cms.vdouble(-1.,-0.09,-0.05,-0.015,0.015,0.05,0.09),
  chasymmax = cms.vdouble(-0.09,-0.05,-0.015,0.015,0.05,0.09,1.0),
