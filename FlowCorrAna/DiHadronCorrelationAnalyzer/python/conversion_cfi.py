...
conversion_ana = cms.EDAnalyzer('ConversionAnalyzer',
...
#  conversionCollection = cms.InputTag('particleFlowEGamma'),

  TriggerID = cms.string('Conversion'),
  ...
  centmin = cms.int32(-1),
  centmax = cms.int32(-1),
  zvtxmin = cms.double(-15000),
  zvtxmax = cms.double(15000),
  zvtxbin = cms.double(30000),
  rhomin = cms.double(0.0),
  rhomax = cms.double(10.2),
