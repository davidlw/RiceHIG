...
scalarprod_ana = cms.EDAnalyzer('ScalarProdVnAnalyzer',
  ...
  etatrgmin = cms.double(0.0),
  etatrgmax = cms.double(1.0),
  etaassmin = cms.double(-5.0),
  etaassmax = cms.double(-3.0),
  pttrgmin = cms.vdouble(0.5, 1.0, 1.5, 2.0, 2.5, 3.0, 4.0, 5.0, 6.0, 8.0, 10.0, 14.0, 20.0, 30.0, 40.0, 60.0),
  pttrgmax = cms.vdouble(1.0, 1.5, 2.0, 2.5, 3.0, 4.0, 5.0, 6.0, 8.0, 10.0, 14.0, 20.0, 30.0, 40.0, 60.0, 100.0),
