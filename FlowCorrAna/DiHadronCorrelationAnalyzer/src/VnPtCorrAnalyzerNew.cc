...
void VnPtCorrAnalyzerNew::beginJob()
{
  ...
  hPairCosn_noweight = theOutputs->make<TH2D>("paircosn_noweight",";n;cos(n#Delta#phi)",1000,0,1000,1000,-1.0,1.0);
  hPairCosnPt_noweight = theOutputs->make<TH2D>("paircosnpt_noweight",";n;cos(n#Delta#phi)*p_{T}",1000,0,1000,1000,-2.0,2.0);
  hPt_noweight = theOutputs->make<TH2D>("pt_noweight",";n;p_{T}",1000,0,1000,500,0,5);
...
//   double Qy2 = -sumcosn_pos[1]*sumsinn_neg[1]+sumsinn_pos[1]*sumcosn_neg[1];
   ...
   hPairCosn_noweight->Fill(npairs_pos+npairs_neg+npairs_mid,Qx2/npairs_pos/npairs_neg);
   hPairCosnPt_noweight->Fill(npairs_pos+npairs_neg+npairs_mid,pt_mid*Qx2/npairs_pos/npairs_neg/npairs_mid);
   hPt_noweight->Fill(npairs_pos+npairs_neg+npairs_mid,pt_mid/npairs_mid);
}
