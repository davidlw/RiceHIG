...
for i in range(1,2):
#    dataMap[("PAHighMultiplicity"+str(i))] = { "PD": ("/PAHighMultiplicity"+str(i)+"/PARun2016C-PromptReco-v1/AOD"), "Units": 20, "Memory": 3000, "RunTime": 2100, "PSet": "../cfg/dedx_data_pPb_cfg.py" } 
    dataMap[("PAMinimumBias"+str(i))] = { "PD": ("/PAMinimumBias"+str(i)+"/PARun2016C-PromptReco-v1/AOD"), "Units": 20, "Memory": 3000, "RunTime": 2100, "PSet": "../cfg/dedx_data_pPb_cfg.py" } 

## Submit the PDs
for key, val in dataMap.items():
    config.General.requestName = 'dEdx_'+key+'_loosedca1p5_20230908v4'
