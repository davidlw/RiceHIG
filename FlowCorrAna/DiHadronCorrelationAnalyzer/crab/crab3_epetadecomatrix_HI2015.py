...
config.General.requestName = 'epetadecomatrix_cent05_pttrg13_ptassallweight_etaass445_eff0_Mu0D_v4'
config.General.workArea = 'HI2015Ana'
config.General.transferOutputs = True
config.General.transferLogs = False

config.JobType.pluginName = 'Analysis'
config.JobType.psetName = '../cfg/epetadecomatrix_2015PbPb_cent05_cfg.py'
