...
V0NTAnalyzer::V0NTAnalyzer(const edm::ParameterSet& iConfig) 
{
  ...
  isFullInfo_     = iConfig.getParameter<bool>("isFullInfo");
/*
...
/*
       ...
       nt_data[12] = dl;
       nt_data[13] = dlerror;
       nt_data[14] = pterror_dau1;
       nt_data[15] = chi2n_dau1;
       nt_data[16] = nhits_dau1;
       nt_data[17] = dzbest1;
       nt_data[18] = dzerror1;
       nt_data[19] = dxybest1;
       nt_data[20] = dxyerror1;
...
void V0NTAnalyzer::beginJob() {
  ...
  {  
    ...
    v0Ntuple = theDQMstore->make<TNtuple>("v0ntuple","v0 ntuple","eta:phi:pt:mass:eta_dau1:phi_dau1:pt_dau1:ch_dau1:eta_dau2:phi_dau2:pt_dau2:ch_dau2");
  }
}
