...
//  recoRecoToSimCollectionTag( iConfig.getUntrackedParameter<edm::InputTag>("trackAssociatorMap")  ),
//  recoSimToRecoCollectionTag( iConfig.getUntrackedParameter<edm::InputTag>("trackAssociatorMap")  ),
...
*/
  ...
  iEvent.getByLabel("trackAssociatorByChi2",theChiAssociator);
  ...
  iEvent.getByLabel("trackAssociatorByHits",theHitsAssociator);
...
/* 
  ...
  iEvent.getByLabel( recoRecoToSimCollectionTag, recotosimCollectionH );
  
  Handle<reco::SimToRecoCollection> simtorecoCollectionH;
  iEvent.getByLabel( recoSimToRecoCollectionTag, simtorecoCollectionH );
*/

  reco::RecoToSimCollection recotosimCollectionH;
  reco::SimToRecoCollection simtorecoCollectionH;
  if(isMatchByHitsOrChi2_) {
    recotosimCollectionH = associatorByHits->associateRecoToSim(trackCollectionH,TPCollectionH );
    simtorecoCollectionH = associatorByHits->associateSimToReco(trackCollectionH,TPCollectionH );
  }
  else {
    recotosimCollectionH = associatorByChi2->associateRecoToSim(trackCollectionH,TPCollectionH );
    simtorecoCollectionH = associatorByChi2->associateSimToReco(trackCollectionH,TPCollectionH );
  }
